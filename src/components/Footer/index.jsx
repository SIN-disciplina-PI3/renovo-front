...
export default function LargeWithLogoLeft() {
  return (
    <Flex justifyContent="center" borderTop="1px" borderColor='#D9D9D9'>
      <Box
        maxW={'1440px'} bg={useColorModeValue('white')}
        ...
        <Container as={Stack} maxW={'6xl'} py={10}>
          ...
          >
            <Stack spacing={6}>
              ...
              <Text fontSize={'sm'}>
                © 2023 Re-novo. Todos os direitos reservados.
              </Text>
            </Stack>
